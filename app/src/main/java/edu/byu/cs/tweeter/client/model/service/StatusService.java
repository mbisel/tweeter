...
public class StatusService {
    ...
    public void loadMoreStoryItens(AuthToken currUserAuthToken, User user, int pageSize, Status lastStatus, GetStoryObserver getStoryObserver) {
    ...
    public void loadMoreFeedItems(AuthToken currUserAuthToken, User user, int pageSize, Status lastStatus, GetFeedObserver getFeedObserver) {
